...
def _calculate_column_alignment(
    ...
    for cluster in clusters:
        ...
        # A real document column should occur
    ...
    # A table needs at least three strong columns.
    if strong_columns < 3:
        return 0.0
...
def _calculate_horizontal_alignment(
    ...
    """
    Measures whether multiple lines begin and end
    in approximately similar horizontal locations.

    This is useful for identifying genuine registers.
    """
...
def classify_layout(
    ...
    key_value_count = (
        _count_key_value_lines(
            line_info
        )
    )

    column_alignment = (
        _calculate_column_alignment(
            lines
        )
    )

    row_consistency = (
        _calculate_row_consistency(
            lines
        )
    )
    ...
    # ROW REGISTER
    #
    # Requires evidence of repeated horizontal rows.
    # ========================================================
